 ...
 *
 * Return: 0 if the first number of bytes of s1 and s2 are equal, otherwise non-zero
 */
...
/**
 * _read - read from file and print an error message upon failure
...
/**
 * elf_magic - prints ELF magic file name
...
/**
 * elf_data - prints the  ELF data
 * @buffer: is the ELF header
 *
...
/**
 * elf_osabi - prints ELF OS/ABI version
 * @buffer: the ELF header
 */
 ...
 * @buffer: string containing entry point address
...
/**
 * main - copies file's contents to another file
 * @argc: the argument count assigned to the program
